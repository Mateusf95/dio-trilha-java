...
public class ConsumerExample {
    public static void main(String[] args) {
        ...
        numeros.forEach(imprimirNumeroPar);// uma maneira de fazer tendo um metodo separado
        numeros.forEach(n -> {
            if(n % 2 == 0){
                System.out.println(n);
            }
        });// uma maneira de fazer usando o lambda
        numeros.stream()
                .filter(n -> n % 2 == 0)
                .forEach(System.out::println);//Uma outra maneira de fazer
    }
}